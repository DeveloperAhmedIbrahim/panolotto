...
--
-- Host: localhost:3306
-- Generation Time: Oct 21, 2024 at 06:56 AM
...
(1, 'Super Admin', 'admin@site.com', 'admin', NULL, '6715f28cbafd61729491596.png', '$2y$10$DPcZdU5ncDNJqfcQyNRYuuvyj4QKYq1QLVcxJ/TNqELQN/JkyxAvO', 'CiSyvoNSgHcdEZRNPRseiBeeAXehy9TsffTEjWknrU7M2bTnUCpAb65laSzq', NULL, '2024-10-21 00:19:56');
...
CREATE TABLE `deposits` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` int UNSIGNED NOT NULL DEFAULT '0',
  `user_pick_id` int UNSIGNED NOT NULL DEFAULT '0',
...
(59, 0, 124, 'SslCommerz', 'SslCommerz', '663a397a70c571715091834.png', 1, '{\"store_id\": {\"title\": \"Store ID\",\"global\": true,\"value\": \"---------\"},\"store_password\": {\"title\": \"Store Password\",\"global\": true,\"value\": \"----------\"}}', '{\"BDT\":\"BDT\",\"USD\":\"USD\",\"EUR\":\"EUR\",\"SGD\":\"SGD\",\"INR\":\"INR\",\"MYR\":\"MYR\"}', 0, NULL, NULL, NULL, '2023-05-06 13:43:01'),
(60, 0, 125, 'Aamarpay', 'Aamarpay', '663a34d5d1dfc1715090645.png', 1, '{\"store_id\": {\"title\": \"Store ID\",\"global\": true,\"value\": \"---------\"},\"signature_key\": {\"title\": \"Signature Key\",\"global\": true,\"value\": \"----------\"}}', '{\"BDT\":\"BDT\"}', 0, NULL, NULL, NULL, '2023-05-06 13:43:01');
...
CREATE TABLE `general_settings` (
  ...
  `request_instruction` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `lotteries` (
  ...
  `name` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_of_ball` int UNSIGNED NOT NULL DEFAULT '0',
  `ball_start_from` int UNSIGNED NOT NULL DEFAULT '0',
  `total_picking_ball` int UNSIGNED NOT NULL DEFAULT '0',
  `has_power_ball` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `no_of_pw_ball` int UNSIGNED NOT NULL DEFAULT '0',
  `pw_ball_start_from` int UNSIGNED NOT NULL DEFAULT '0',
  `total_picking_power_ball` int UNSIGNED NOT NULL DEFAULT '0',
  `price` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `line_variations` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `multi_draw_options` (
  `id` bigint NOT NULL,
  `lottery_id` int UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `phases` (
  ...
  `phase_no` int UNSIGNED NOT NULL DEFAULT '0',
  `draw_date` datetime DEFAULT NULL,
  `winning_normal_balls` text COLLATE utf8mb4_unicode_ci,
  `winning_power_balls` text COLLATE utf8mb4_unicode_ci,
  `draw_at` timestamp NULL DEFAULT NULL,
  `is_set_winner` tinyint NOT NULL DEFAULT '0',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `phase_creation_schedules` (
  ...
  `day` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `picked_tickets` (
  `id` bigint NOT NULL,
  `user_pick_id` int UNSIGNED NOT NULL DEFAULT '0',
  `normal_balls` text COLLATE utf8mb4_unicode_ci,
  `power_balls` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `user_multi_draws` (
  ...
  `user_pick_id` int UNSIGNED NOT NULL DEFAULT '0',
  `total_draw` int UNSIGNED NOT NULL DEFAULT '0',
  `remaining_draw` int UNSIGNED NOT NULL DEFAULT '0',
  `amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE `winners` (
  ...
  `user_id` int UNSIGNED NOT NULL DEFAULT '0',
  `phase_id` int UNSIGNED NOT NULL DEFAULT '0',
  `picked_ticket_id` int UNSIGNED NOT NULL DEFAULT '0',
  `normal_balls` text COLLATE utf8mb4_unicode_ci,
  `power_balls` text COLLATE utf8mb4_unicode_ci,
  `combination` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'power ball x normal ball',
...
CREATE TABLE `winning_settings` (
  `id` bigint NOT NULL,
  `lottery_id` int UNSIGNED NOT NULL DEFAULT '0',
  `normal_ball` int UNSIGNED NOT NULL DEFAULT '0',
  `power_ball` int UNSIGNED NOT NULL DEFAULT '0',
